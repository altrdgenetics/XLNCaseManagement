 ...
 * @author User
 */
public class MaintenancePartyRelationTypeTableModel {
    
    public ObjectProperty object = new SimpleObjectProperty(null);
    public BooleanProperty active = new SimpleBooleanProperty(false);
    public StringProperty partyRelationType = new SimpleStringProperty(null);

    public MaintenancePartyRelationTypeTableModel(Object object, boolean active, String partyRelationType) {
        this.object = new SimpleObjectProperty(object);
        this.active = new SimpleBooleanProperty(active);
        this.partyRelationType = new SimpleStringProperty(partyRelationType);
    }
    ...
    public StringProperty getPartyRelationType() {
        return partyRelationType;
    }

    public void setPartyRelationType(StringProperty partyRelationType) {
