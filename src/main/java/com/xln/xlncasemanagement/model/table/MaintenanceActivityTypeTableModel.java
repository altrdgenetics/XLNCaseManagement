 ...
 * @author User
 */
public class MaintenanceActivityTypeTableModel {
    
    public ObjectProperty object = new SimpleObjectProperty(null);
    public BooleanProperty active = new SimpleBooleanProperty(false);
    public StringProperty activityType = new SimpleStringProperty(null);

    public MaintenanceActivityTypeTableModel(Object object, boolean active, String activityType) {
    ...
    public StringProperty getActivityType() {
        return activityType;
    }

    public void setActivityType(StringProperty activityType) {
