 ...
 * @author User
 */
public class MaintenanceModelTableModel {
    ...
    public StringProperty model = new SimpleStringProperty(null);
    public StringProperty webSite = new SimpleStringProperty(null);

    public MaintenanceModelTableModel(Object object, boolean active, String make, String model, String webSite) {
