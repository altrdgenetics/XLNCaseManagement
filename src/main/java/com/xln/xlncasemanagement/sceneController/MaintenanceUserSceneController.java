 ...
 * @author User
 */
public class MaintenanceUserSceneController implements Initializable {
    ...
    @FXML private TableColumn<UserMaintanceTableModel, String> userNameColumn;
    @FXML private TableColumn<UserMaintanceTableModel, String> lastSignIn;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        userNameColumn.setCellValueFactory(cellData -> cellData.getValue().getName());
        lastSignIn.setCellValueFactory(cellData -> cellData.getValue().getLastSignIn());
    ...
    private void loadTable(ObservableList<UserMaintanceTableModel> list) {
    ...
    @FXML private void addNewButtonAction() {
        Global.getStageLauncher().MaintenanceUserAddEditScene(stage, null);
        search();
    }
    
    @FXML private void editButtonAction() {
        UserMaintanceTableModel row = searchTable.getSelectionModel().getSelectedItem();
