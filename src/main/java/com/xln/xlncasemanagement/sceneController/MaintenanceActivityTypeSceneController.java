...
public class MaintenanceActivityTypeSceneController implements Initializable {
    ...
    @FXML
    private TableColumn<MaintenanceActivityTypeTableModel, String> companyColumn;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        companyColumn.setCellValueFactory(cellData -> cellData.getValue().getActivityType());
